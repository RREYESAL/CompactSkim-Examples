// -*- C++ -*-
//
// Package:    PsiTrakKinematicFit
// Class:      PsiTrakKinematicFit
// 
/**\class PsiTrakKinematicFit Ponia/OniaTrak/src/PsiTrakKinematicFit.cc
...
class PsiTrakKinematicFit : public edm::EDProducer {
   public:
      explicit PsiTrakKinematicFit(const edm::ParameterSet&);
      ~PsiTrakKinematicFit();
...
PsiTrakKinematicFit::PsiTrakKinematicFit(const edm::ParameterSet& iConfig) {
  oniat_cand_   = iConfig.getParameter<edm::InputTag>("PsiTrak");
...
PsiTrakKinematicFit::~PsiTrakKinematicFit() {
}
...
void PsiTrakKinematicFit::produce(edm::Event& iEvent, const edm::EventSetup& iSetup) {
...
// Kinematic fit
  ...
  for (pat::CompositeCandidateCollection::const_iterator oniat=PsiTCandHandle->begin(); oniat!=PsiTCandHandle->end(); ++oniat) {
    ...
    reco::TrackRef JpsiTk[3]={
      ...
      ( dynamic_cast<const pat::GenericParticle*>(oniat->daughter("trak")) )->track()
    };
...
// Get PsiT reffited
       ...
       if ( oniat_ma_fit < 6. && oniat_x2_fit < 100. ) {
	    ...
	    reco::CompositeCandidate recoPsiT(oniat_ch_fit,math::XYZTLorentzVector(oniat_px_fit,oniat_py_fit,oniat_pz_fit,oniat_en_fit),
                                               math::XYZPoint(oniat_vx_fit,oniat_vy_fit,oniat_vz_fit),521);
...
// get kaon
	    ...
	    patPsiT.addDaughter(patTk,"trak");
...
// now sort by vProb
  PsiTrakKinematicFit::GreaterByVProb<pat::CompositeCandidate> vPComparator;
  std::sort(PsiTCandRefitColl->begin(),PsiTCandRefitColl->end(),vPComparator);
  iEvent.put(PsiTCandRefitColl,product_name_);
}

// ------------ method called once each job just before starting event loop  ------------
void PsiTrakKinematicFit::beginJob() {}

// ------------ method called once each job just after ending the event loop  ------------
void PsiTrakKinematicFit::endJob() {}

// ------------ method called when starting to processes a run  ------------
void PsiTrakKinematicFit::beginRun(edm::Run&, edm::EventSetup const&) {}

// ------------ method called when ending the processing of a run  ------------
void PsiTrakKinematicFit::endRun(edm::Run&, edm::EventSetup const&) {}

// ------------ method called when starting to processes a luminosity block  ------------
void PsiTrakKinematicFit::beginLuminosityBlock(edm::LuminosityBlock&, edm::EventSetup const&) {}

// ------------ method called when ending the processing of a luminosity block  ------------
void PsiTrakKinematicFit::endLuminosityBlock(edm::LuminosityBlock&, edm::EventSetup const&) {}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void PsiTrakKinematicFit::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(PsiTrakKinematicFit);
